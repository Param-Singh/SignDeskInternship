  ...
  try {
    ...
    //     }
        MongoClient.connect("mongodb://localhost:27017", function (err, db) {
          ...
          var pManu = req.body.manufacture_id;
  ...
  try {
    ...
    //     }
        MongoClient.connect("mongodb://localhost:27017", function (err, db) {
          ...
          console.log("connected");
          console.log("coll obtained");
          var did = parseInt(req.params.id.substring(1)); //comes in the url
          console.log(did);
          coll
...
module.exports = { listProducts, addProducts, deleteProducts, getProductById,updateProducts };
